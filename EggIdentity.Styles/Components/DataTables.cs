...
internal static class DataTables {
    internal static readonly ImmutableDictionary<string, string> Applies = new Dictionary<string, string> {
        ...
        { ".data-table .cell-clip", "max-w-[22rem] overflow-hidden text-ellipsis" },
        { ".data-table .data-table-actions", "sticky right-0 z-[5] bg-panel border-l border-border" },
        { ".data-table thead th.data-table-actions", "z-20" },
        { ".data-table tbody tr:hover .data-table-actions", "bg-panel2" },
