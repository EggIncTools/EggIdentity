...
internal static class Modals {
    internal static readonly ImmutableDictionary<string, string> Applies = new Dictionary<string, string> {
        ...
        { ".modal-card", "w-full max-w-3xl bg-panel border border-border rounded-lg flex flex-col max-h-[calc(100dvh-2rem)] overflow-hidden shadow-[0_20px_25px_-5px_rgba(0,0,0,.4)]" },
