...
public class ComponentContractTests {
    ...
    public void All_Keys_MatchGoldenSelectorSet() {
        var expected = new HashSet<string> {
            ...
            ".btn-primary", ".btn-primary:disabled", ".btn-primary:hover:not(:disabled)", ".btn-secondary", ".btn-secondary:hover", ".btn-accent", ".btn-accent:disabled", ".btn-accent:hover:not(:disabled)", ".btn-mini", ".btn-mini:hover", ".btn-danger.btn-danger", ".btn-danger.btn-danger:hover",
            ".panel", ".panel-head", ".panel-title",
            ".segmented", ".segmented-opt", ".segmented-opt.active", ".segmented-opt:disabled",
            ".popover-wrap", ".popover", ".popover.open", ".popover.popover-sm", ".popover.popover-lg", ".popover.popover-combo", ".popover.popover-combo:popover-open", ".popover-combo-opt", ".popover-combo-opt:hover", ".popover-combo-opt.combo-highlighted",
            ".modal-backdrop", ".modal-card", ".modal-card.modal-card-sm", ".modal-card.modal-card-lg", ".modal-head", ".modal-title", ".modal-body",
            ".fab-bubble", ".fab-bubble:hover",
            ".form-input", ".form-input:focus", ".form-select", ".form-select:focus", ".form-check",
            ".data-table", ".data-table thead th", ".data-table td", ".data-table tbody tr", ".data-table tbody tr:hover",
            ".data-table .cell-clip", ".data-table .data-table-actions", ".data-table thead th.data-table-actions", ".data-table tbody tr:hover .data-table-actions",
            ...
            ".filter-remove-btn", ".filter-remove-btn:hover", ".filter-field", ".filter-field > input", ".filter-glass",
